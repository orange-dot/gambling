...
## Rezime
- Tvrdnje vezane za datum primene, nove mehanizme zastite igraca, tehnicke zahteve i fiskalne obaveze u velikoj meri se poklapaju sa tekstom izmene Zakona o igrama na srecu (*Sl. glasnik RS* 94/2024) i preciscenim tekstom zakona.
- Najjace tvrdnje o obimu sive ekonomije, broju inspektora, broju zavisnika i ukupan broj onlajn licenci nisu potkrepljene javno dostupnim izvorima, pa ostaju u domenu spekulacije.

## Statusi
- `Potvrdjeno` – tvrdnja je eksplicitno obuhvacena verodostojnim izvorom.
- `Delimicno potvrdjeno` – deo tvrdnje je potvrdjen, ali ostatak nije moguce proveriti ili nema izvor.
- `Neutvrdjeno` – nije pronadjen kredibilan javni izvor koji bi potvrdio ili demantovao tvrdnju.
- `Suprotno` – pronadjen je izvor koji direktno demantuje tvrdnju.

## Ključne tvrdnje iz analize

| Tema | Tvrdnja iz dokumenta | Status | Napomena | Izvor(i) |
| --- | --- | --- | --- | --- |
| Primena zakona | Izmene zakona stupile su na snagu 6.12.2024, primena novih pravila krece 6.1.2025, a potpuna uskladjenost se trazi do 1.7.2026. | Potvrdjeno | Datumi i prelazni rokovi navedeni su u cl. 68 izmene zakona i potvrdjeni vestima resornog portala. | [1], [3] |
| Novi mehanizmi | Reforma uvodi obaveznu verifikaciju starosti, centralnu evidenciju, samoiskljucenje/samoogranicenje i limite gotovine 1.175.000 RSD u 30 dana. | Potvrdjeno | Definicije i obaveze unete cl. 5, 29, 95a izmene zakona, a limit isplata u cl. 105 tac. 29 starog zakona. | [1], [2] |
| Posteri i zabrane | Obavezni posteri 100x80 cm sa informacijama o prevenciji, zabrana sluzenja hrane i alkohola >5% u klubovima/kladionicama. | Potvrdjeno | Cl. 2 izmene zakona, cl. 59 preciscenog teksta. | [1], [2] |
| Video nadzor | Uprava mora imati link za pracenje uzivo; snimci se cuvaju 90 dana. | Potvrdjeno | Cl. 18 izmene zakona menja cl. 50 osnovnog zakona i propisuje novi rok cuvanja. | [1] |
| Rastojanje od skola | Minimalno rastojanje 200 m do obrazovnih ustanova uz misljenje vestaka; rastojanje izmedju klubova/kladionica min. 100 m. | Potvrdjeno | Cl. 67 preciscenog teksta. | [2] |
| Kazina – broj i kapital | Max 10 dozvola, min kapital 1.000.000 EUR, min 15 stolova. | Potvrdjeno | Cl. 35, 36 i 49 preciscenog teksta. | [2] |
| Kazina – jednokratna naknada 1.000.000 EUR (ranije 500.000) | Delimicno potvrdjeno | Trenutni minimum od 1.000.000 EUR je potvrdjen; tvrdnja o prethodnom iznosu 500.000 EUR nije potkrepljena izvorom. | [2] |
| Automati – uslovi | Min kapital 250.000 EUR, min 100 automata u portfoliju, min 5 automata po lokaciji, depozit 500 EUR po aparatu, dnevni riziko depozit 100 EUR. | Potvrdjeno | Cl. 59-63 i 68 preciscenog teksta. | [2] |
| Kladenje – depozit | Minimum 5.000 EUR po kladionici (1.500.000 EUR za 300 lokacija). | Potvrdjeno | Cl. 79 preciscenog teksta. | [2] |
| Onlajn operateri – kapital i naknade | Min kapital 250.000 EUR, depozit 500.000 EUR, naknada za odobrenje 10.000 EUR mesecno, naknada za priredivanje 15% (25% za live igre). | Potvrdjeno | Cl. 94, 101-102 preciscenog teksta; cl. 5 izmene zakona definise diferencirane stope. | [1], [2] |
| Porez na klasicne igre | 60% na osnovicu i obavezan fond dobitaka ≥50%. | Potvrdjeno | Cl. 33 preciscenog teksta. | [2] |
| "15 novih definicija" | Delimicno potvrdjeno | Izmene su prosirile listu definicija na 32 pojma, ali nema izvora koji specificira da je tacno 15 novih. | [1] |
| Uprava ima samo 6 inspektora | Neutvrdjeno | Nije pronadjen zvanican podatak u dostupnim javnim izvorima. | — |
| 74% sive zone / 60.000 nelegalnih automata / 1.500 nelicenciranih / 79,5 mil. EUR gubitaka | Neutvrdjeno | Potraga po javno dostupnim vestima i saopstenjima (UIS, ministarstvo finansija, udruzenja) nije dala kvantifikovan izvor sa navedenim brojkama. | — |
| 300.000 gradjana sa znacima zavisnosti, 10% trazi pomoc, 72% ne vidi kockanje kao zavisnost | Neutvrdjeno | Nije pronadjen relevatan istrazivacki ili institucionalni izvor sa ovim indikatorima. | — |
| 21 licencirani onlajn operater | Neutvrdjeno | UIS objavljuje listu odobrenja, ali javno dostupni podaci ne potvrduju broj 21 za 2025. godinu. | — |
| Poredjenje sa Ceskom (100.000 -> 20.000 automata, 20-30% crnog trzista) | Neutvrdjeno | Brojevi se ne podudaraju sa dostupnim statistikama Evropske komisije ili ceskih regulatora u poslednjih pet godina. | — |
